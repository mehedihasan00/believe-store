...
@section('web-content')
{{-- <section id="elementor" class="elementor">
    <div class="container">
        <div class="feature-box">
            <div class="row">
                <div class="col-12 col-md-12">
                    <h2 class="elementor-title text-center">Feature Menu</h2>
                </div>
            </div>
        </div>
    </div>
...
<section id="best-choice" class="custom-product">
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-12">
                <h2 class="custom-product-title text-uppercase wow slideInLeft" data-wow-duration="1s">New Product</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-3 col-12 padding-bottom-24">
